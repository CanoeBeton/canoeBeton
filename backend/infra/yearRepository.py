...
class YearRepository:
    ...
    def update(self, year: YearRequest, id):
        self.connection.change(f'UPDATE {YearRepository.TABLE} SET year = "{year.year}", boat_name = "{year.boat_name}", partenaire_mosaique = "{year.partenaire_mosaique}", icone="{year.icone}" WHERE id = {id}')
